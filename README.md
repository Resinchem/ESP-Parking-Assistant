...
If you just want to install the firmware for the ESP8266, download the .bin file from the Releases page.  You do not need to download anything from the /src folder nor do you need to clone the repository.  Please follow the wiki instructions before posting questions.
